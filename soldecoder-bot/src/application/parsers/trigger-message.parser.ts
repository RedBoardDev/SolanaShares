 ...
 */
export function parseTakeProfitTrigger(content: string): z.SafeParseReturnType<any, any> {
 ...
 *  - thresholdPct: the threshold percentage that was exceeded (e.g. 1)
 */
export function parseStopLossTrigger(content: string): z.SafeParseReturnType<any, any> {

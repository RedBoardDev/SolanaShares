...
import { BotPermissionError, ChannelAccessError } from '@application/errors/permission.errors';
import {
  ChannelNotFoundError,
  InvalidChannelTypeError,
  ChannelFeaturePermissionError,
  MentionPermissionError,
} from '@application/errors/channel.errors';

export class PermissionValidatorService implements PermissionValidator {
